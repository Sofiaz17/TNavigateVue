...
//   },
//   // mounted() {
//   //   this.$refs.mapRef.value.$mapPromise.then((map)=>{
//   //     this.map = map;
//   //     console.log('map: ' + map);
//   //   })
//   //   this.$nextTick(()=>{
//   //     let self = this
//   //     console.log('$refffff' + self.$refs) // Shows the mapRef object reference
//   //     console.log(self.$refs.mapRef.value);
//   //     console.log('$ref: '+ this.$refs.mapRef.value);
//   //   })
